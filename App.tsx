  ...
  return (
    <div className="min-h-screen relative selection:bg-indigo-100 selection:text-indigo-900">
      ...
      <div className="relative z-10 w-full min-h-screen">
        <main className="max-w-7xl mx-auto px-6 py-12 lg:py-20 flex flex-col lg:flex-row gap-12">
          {/* Left Column: Branding */}
          <MDiv
            initial={{ opacity: 0, x: -50 }}
            animate={{ opacity: 1, x: 0 }}
            transition={{ duration: 0.8, ease: "easeOut" }}
            className="lg:w-5/12 flex flex-col items-center lg:items-start text-center lg:text-left lg:sticky lg:top-24 h-fit"
          >
